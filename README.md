...
There's nothing special about `src/components/`, but that's where
we like to put any Astro/React/Vue/Svelte/Preact components.
...
All commands are run from the root of the project, from a
terminal:
